defmodule MyexpensesPhxV2Web.ExpenseControllerTest do
  ...
  @create_attrs %{date: ~D[2010-04-17], installmentUUID: "some installmentUUID", name: "some name", value: 42}
  @update_attrs %{date: ~D[2011-05-18], installmentUUID: "some updated installmentUUID", name: "some updated name", value: 43}
