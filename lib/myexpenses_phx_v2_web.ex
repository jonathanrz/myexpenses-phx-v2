defmodule MyexpensesPhxV2Web do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MyexpensesPhxV2Web
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/myexpenses_phx_v2_web/templates",
        namespace: MyexpensesPhxV2Web
